    ...
    <div className="cards-sections">
      <div className="cards-section-one">
        <Card
          ...
          img={
            <StaticImage
              src="../../assets/images/cards/time.png"
              loading="eager"
              width={48}
              quality={95}
          ...
          content={
            <p>
              <span className="card__content--underline card__content__big">
                Lundi au dimanche
              </span>
              <br></br>
              ...
              <br></br>
              <span className="card__content--underline">
                Sans interruption
              </span>
            </p>
          }
        ...
        <Card
          ...
          img={
            <StaticImage
              src="../../assets/images/cards/write.png"
              loading="eager"
              width={48}
              quality={95}
              formats={["AUTO", "WEBP", "AVIF"]}
                ...
                return data !== "Vaccination Covid" ? (
                  ...
                  <li key={index}>
                    ...
                    >
                      - {data}
                      <StaticImage
                        src="../../assets/images/icons/icon-red-link.png"
                        loading="eager"
                        width={16}
                        quality={95}
                        formats={["AUTO", "WEBP", "AVIF"]}
      ...
      <div className="cards-section-two">
        <Card
          ...
          img={
            <StaticImage
              src="../../assets/images/cards/scanner.png"
              loading="eager"
              width={48}
              quality={95}
              formats={["AUTO", "WEBP", "AVIF"]}
        ...
        <Card
          ...
          img={
            <StaticImage
              src="../../assets/images/cards/bottle.png"
              loading="eager"
              width={52}
              quality={95}
              formats={["AUTO", "WEBP", "AVIF"]}
        ...
        <Card
          ...
          img={
            <StaticImage
              src="../../assets/images/cards/paramedical.png"
              loading="eager"
              width={48}
              quality={95}
              formats={["AUTO", "WEBP", "AVIF"]}
